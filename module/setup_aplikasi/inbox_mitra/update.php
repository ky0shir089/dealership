...
$sql = "insert into hr_people_all(person_id,person_name,person_outlet,person_create_by,person_created) values('$req_id','$req_nama','$req_outlet','$_SESSION[uid]',now());";
$sql .= "update request_id set req_id='$req_id',req_status='A' where req_seq='$id';";
