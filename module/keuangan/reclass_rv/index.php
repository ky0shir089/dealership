		...
		<table>
			...
			<tr>
				<td colspan="3" align="center">
					<a href="javascript:void(0)" id="btnSubmit" class="easyui-linkbutton" iconCls="icon-save" onclick="submitForm()" disabled>Submit</a>
					<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-reload" onclick="reset()">Reset</a>
				</td>
			</tr>
		</table>
		<!-- LOV -->
		<div id="dlg" class="easyui-dialog" style="width:680px;height:400px;padding:10px 20px"
			...
			<table id="dg" class="easyui-datagrid" style="height:340px" 
				...
				<thead>
					<tr>
						...
						<th field="nama_titik" width="150px">Outlet</th>
						<th field="rv_received_from" width="200px">Keterangan</th>
